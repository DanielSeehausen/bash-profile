# This is a constantly evolving bash profile script made by Daniel Seehausen.
...
if [ "$color_prompt" = yes ]; then
    PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u: \[\033[33m\]\$(PWD)\[\033[0m\] \$ "
else
